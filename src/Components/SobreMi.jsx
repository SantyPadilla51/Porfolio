    ...
    return (
        <>
            <div id="SobreMi" className="m-3" >
                <h1 className="text-cyan-700 uppercase font-bold text-5xl mt-96 ">Sobre Mi</h1>
                <p className="text-white mt-10 w-full" >¡Hola! Soy Santiago, tengo 24 años y soy un apasionado desarrollador de software en el mundo web y de aplicaciones.
                ...
                <h2 className="mt-14 uppercase text-cyan-700 text-2xl font-semibold">
                    Actualemente me encuentro en la carrera de Tecnico Superior en Desarrollo de Software
                </h2>
            </div>
